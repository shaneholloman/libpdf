 ...
 */
export function unicodeToGlyphName(unicode: number): string | undefined {
 ...
 */
export const UNICODE_TO_GLYPH = new Map<number, string>([
  ...
  [0x007d, "braceright"],
  [0x007e, "asciitilde"],
  // Latin-1 Supplement (common extended characters)
  [0x00a0, "nbspace"],
  [0x00a1, "exclamdown"],
  [0x00a2, "cent"],
  [0x00a3, "sterling"],
  ...
  [0x00bf, "questiondown"],
  // Latin Extended-A (accented capitals)
  [0x00c0, "Agrave"],
  [0x00c1, "Aacute"],
  [0x00c2, "Acircumflex"],
  [0x00c3, "Atilde"],
  ...
  [0x00de, "Thorn"],
  [0x00df, "germandbls"],
  // Latin Extended-A (accented lowercase)
  [0x00e0, "agrave"],
  [0x00e1, "aacute"],
  [0x00e2, "acircumflex"],
  [0x00e3, "atilde"],
